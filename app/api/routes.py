...
from models import db, User, contacts_schema, contact_schema, Contact
...
def create_contact(current_user_token):
    ...
    contact = Contact(name, email, phone_number, address, user_token)
...
def update_contact(current_user_token, id):
    ...
    contact.uster_token = current_user_token.token
